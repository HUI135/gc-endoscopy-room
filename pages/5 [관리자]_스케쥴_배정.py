...
with col3:
    duty_830 = st.selectbox("당직방", rooms_830 if rooms_830 else room_options, index=0, key="830_duty")
...
with col2:
    duty_1330 = st.selectbox("당직방", rooms_1330 if rooms_1330 else room_options, index=0, key="1330_duty")
